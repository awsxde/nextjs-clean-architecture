...
it('deletes record', async () => {
  ...
  await expect(
    deleteRecordController({ recordId: record.id }, session.id)
...
it('throws when unauthorized', async () => {
  ...
  await expect(
    deleteRecordController({ recordId: record.id }, sessionTwo.id)
...
it('throws for invalid input', async () => {
  ...
  await expect(
    deleteRecordController({ recordId: 1234567890 }, session.id)
